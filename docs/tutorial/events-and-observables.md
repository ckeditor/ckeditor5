...
Otherwise, go to the next chapter where you'll {@link tutorial/keystrokes learn more about handling keystrokes}, which also use CKEditor's event system.
