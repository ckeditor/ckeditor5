...
If you use a {@link getting-started/legacy-getting-started/predefined-builds predefined build}, you can simply visit our [CKEditor&nbsp;5 download page](https://ckeditor.com/ckeditor-5/download/) and get the latest editor version from there. However, if you created your own customized editor, the process can be described in a few steps:
