...
If you wish to bring back this restriction, see the {@link features/tables-nesting#disallow-nesting-tables Disallow nesting tables} section of the table feature guide.
