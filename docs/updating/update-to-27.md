...
meta-description: Follow the guide to update CKEditor 5 to version 27.x, including key changes, migration tips, and compatibility considerations.
...
If you wish to bring back this restriction, see the {@link features/tables-installation#disallow-nesting-tables#disallow-nesting-tables Disallow nesting tables} section of the table feature guide.
