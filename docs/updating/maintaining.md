...
Some releases would bring new features and new plugins and sometimes replace old ones and make them obsolete. If you want to install additional plugins, it is easier and safer to use the [CKEditor&nbsp;5 Builder](https://ckeditor.com/builder?redirect=docs) instead of {@link getting-started/setup/installing-plugins adding them manually}. This will reduce the risk of omitting plugin dependencies.
