...
If you would like to create such a widget on your own, take a look at the {@link tutorials/data-from-external-source dedicated tutorial} which shows how to achieve this step by step with the source code provided. 
