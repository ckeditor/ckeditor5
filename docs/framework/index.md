...
The CKEditor 5 predefined builds {@link installation/getting-started/quick-start-other#build-customization can be customized}, but certain types of customizations require using the framework.
