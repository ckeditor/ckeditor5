...
Registering a toolbar button doesn't differ in TypeScript implementation.
...
If you use TypeScript, the code responsible for the plugin functionality can remain the same.
