...
Attach the inspector to the editor instance when {@link installation/legacy-getting-started/editor-lifecycle#creating-an-editor-with-create created} using the `CKEditorInspector.attach()` method:
