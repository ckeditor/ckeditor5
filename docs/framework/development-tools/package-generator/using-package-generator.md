...
```bash
npx ckeditor5-package-generator <packageName> [--use-pnpm] [--use-npm] [--use-yarn] [--installation-methods <current|current-and-legacy>] [--plugin-name <...>] [--lang <js|ts>] [--global-name <...>] [--verbose]
```
