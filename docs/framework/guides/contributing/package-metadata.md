...
In case of official CKEditor 5 packages (as well as some partner ones), this data is used by the [CKEditor 5 Online Builder](https://ckeditor.com/ckeditor-5/online-builder/) and allows for building the {@link installation/features-html-output-overview Features' HTML output} page presenting a list of all official CKEditor 5 plugins.
