...
<info-box>
	Check out the {@link framework/guides/deep-dive/event-system deep dive into event system} and the {@link framework/guides/deep-dive/observables deep dive into observables} guides to learn more about the advanced usage of events and observables with some additional examples.
</info-box>
