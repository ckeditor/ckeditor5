...
* Since you are here, you probably have at least some basic understanding of what React is and how it works. But what you might not know is that CKEditor 5 has an official {@link installation/frameworks/react **rich text editor component for React**} and it will be one of the key features used in this tutorial. Learning how to {@link installation/frameworks/react#integrating-the-editor-from-source use it in your project} is a good place to start.
...
Create a minimal [webpack](https://webpack.js.org) configuration and save it as `webpack.config.js` in the root of the application. To learn more about using webpack with CKEditor 5 and React, check out the {@link installation/frameworks/react#integrating-the-editor-from-source Integrating CKEditor 5 built from source} section of the CKEditor 5 React component guide.
