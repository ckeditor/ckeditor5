...
This guide will describe the contents of the `TypeScript` package generated by the {@link framework/guides/package-generator/using-package-generator Package Generator}. Please bear in mind, that the transition of CKEditor 5 codebase to TypeScript is in progress and hence some errors might occur. If you encounter one, please [report it](#reporting-issues).
...
│  ├─ myplugin.ts          # Very basic plugin that utilizes the CKEditor 5 framework.
