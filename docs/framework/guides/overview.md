...
{@link installation/getting-started/quick-start#building-the-editor-from-source CKEditor 5 builds can be customized}, but certain types of customizations require using the framework.
