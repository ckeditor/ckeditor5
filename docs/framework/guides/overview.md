...
{@link installation/getting-started/quick-start#creating-custom-builds CKEditor 5 builds can be customized}, but certain types of customizations require using the framework.
