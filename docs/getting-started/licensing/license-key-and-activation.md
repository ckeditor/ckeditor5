...
To use premium features, you need to add the relevant plugins to your CKEditor&nbsp;5. You can use the [CKEditor&nbsp;5 Builder](https://builder.ckeditor.com/?redirect=docs) to generate a CKEditor&nbsp;5 preset with the plugins enabled.
