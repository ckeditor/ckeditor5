...
<info-box warning>
	⚠️  This is a legacy guide kept for users' convenience. If you want to learn more about these changes, please refer to the {@link updating/nim-migration/customized-builds Migrating from customized builds} guide.
</info-box>
