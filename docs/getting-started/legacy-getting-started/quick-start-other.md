...
* Designing a {@link getting-started/legacy-getting-started/configuration#toolbar-setup customized toolbar experience}.
...
Read more in the {@link getting-started/legacy-getting-started/configuration Configuration guide}.
...
Congratulations, you have just run your first CKEditor&nbsp;5 instance! Now it is time to learn more about customization, so jump in straight to the {@link getting-started/legacy-getting-started/configuration Configuration guide}.
