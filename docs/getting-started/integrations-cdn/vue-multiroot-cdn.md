...
meta-title: Using CKEditor 5 with Vue.js 3+ multi-root component from CDN | CKEditor 5 Documentation
meta-description: Install, integrate, and configure CKEditor 5 using the Vue.js 3+ multi-root component with CDN.
...
This page focuses on describing the usage of the multi-root editor in Vue applications. For other editor types, see the {@link getting-started/integrations-cdn/vue-default-cdn default Vue.js 3+ integration}.
...
Install the [CKEditor&nbsp;5 WYSIWYG editor package for Vue](https://www.npmjs.com/package/@ckeditor/ckeditor5-vue).
...
integrator should do instead. Only the removed API was stripped here. -->
