...
<info-box>
	In the example above, we only used basic features of the `<CKEditor>` component. To learn more about additional features and configuration options &ndash; including inline editors and the multi-root variant &ndash; refer to the {@link getting-started/integrations-cdn/react-default-cdn React integration guide}.
</info-box>
