...
You can use the CKEditor&nbsp;5 rich-text editor in a [jQuery](https://jquery.com/) project by loading CKEditor&nbsp;5 from the CDN and initializing the editor on a DOM element selected with jQuery.
