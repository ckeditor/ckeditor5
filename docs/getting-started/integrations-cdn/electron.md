---
category: cloud
meta-title: Using the CKEditor 5 WYSIWYG editor with Electron from CDN | CKEditor 5 Documentation
...
Here we adjusted the structure to include the `<div>` placeholder for the editor instance. We have also added CDN links to the editor's styles, source files and finally `editor.js` file, which is responsible for tying everything together and initializing the editor.
