...
meta-title: Integration with Salesforce | CKEditor 5 Documentation
meta-description: Integrate CKEditor 5 with Salesforce
...
For our CKEditor 5 integration, we'll use a basic page structure that includes necessary JavaScript and CSS resources, along with a container for the editor. The page markup will look similar to this:
