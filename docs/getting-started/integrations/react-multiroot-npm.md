...
meta-title: Using CKEditor 5 with React rich text editor multi-root hook via npm | CKEditor 5 Documentation
...
# Integrating CKEditor 5 with React rich text multi-root editor hook via npm
