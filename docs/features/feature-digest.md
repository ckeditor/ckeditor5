...
<ck:button-link size='sm' variant='secondary' href='{@link features/remove-format}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/select-all}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/text-alignment}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/undo-redo}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/mentions}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/users}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/export-with-inline-styles}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/markdown}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/paste-markdown}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link module:engine/dataprocessor/xmldataprocessor~XmlDataProcessor}'>
	Feature page
</ck:button-link>
...
<ck:heading-badge heading-id='document-outline' badge='premium'>Document outline</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/document-outline}'>
	Feature page
</ck:button-link>
...
<ck:heading-badge heading-id='pagination' badge='premium'>Pagination</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/pagination}'>
	Feature page
</ck:button-link>

<ck:heading-badge heading-id='table-of-contents' badge='premium'>Table of contents</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/table-of-contents}'>
	Feature page
</ck:button-link>
...
<ck:columns>
	...
	<ck:card>
		<ck:card-title level='4' heading-id='ai-multi-root'>
			AI in multi-root and multi-editor setups <ck:badge variant='premium' />
		</ck:card-title>
		<ck:card-description>
			Support for AI Chat, Review, and Translate across multi-root editors and across multiple editors sharing a Context. Suggestions, translations, and chat history stay scoped to the right surface.
		</ck:card-description>
		<ck:card-footer>
...
<ck:heading-badge heading-id='case-change' badge='premium'>Case change</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/case-change}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/emoji}'>
	Feature page
</ck:button-link>
...
<ck:heading-badge heading-id='format-painter' badge='premium'>Format painter</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/format-painter}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/fullscreen}'>
	Feature page
</ck:button-link>
...
<ck:heading-badge heading-id='math-type' badge='premium'>MathType</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/math-equations}'>
	Feature page
</ck:button-link>

<ck:heading-badge heading-id='merge-fields' badge='premium'>Merge fields</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/merge-fields}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/paste-from-google-docs}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/paste-from-office}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/paste-plain-text}'>
	Feature page
</ck:button-link>

<ck:heading-badge heading-id='slash-commands' badge='premium'>Slash commands</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/slash-commands}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/special-characters}'>
	Feature page
</ck:button-link>

<ck:heading-badge heading-id='templates' badge='premium'>Templates</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/template}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/editor-placeholder}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/read-only}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/language}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/word-count}'>
	Feature page
</ck:button-link>

<ck:heading-badge heading-id='wproofreader' badge='premium'>WProofreader</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/base64-upload-adapter}'>
	Feature page
</ck:button-link>
...
<ck:heading-badge heading-id='ckfinder' badge='premium'>CKFinder</ck:heading-badge>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/ckfinder}'>
	Feature page
</ck:button-link>
...
<ck:button-link size='sm' variant='secondary' href='{@link features/simple-upload-adapter}'>
	Feature page
</ck:button-link>

<ck:heading-badge heading-id='uploadcare' badge='premium'>Uploadcare</ck:heading-badge>
