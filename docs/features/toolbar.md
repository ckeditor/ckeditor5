...
Refer to the {@link tutorial/editor step-by-step tutorial} to learn how to build your own plugin, register its button and add it to the toolbar configuration.
