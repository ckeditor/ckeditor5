...
If you would like to integrate you CKEditor 5 installation with one of the popular Java Script frameworks, {@link installation/frameworks/overview we have a dedicated guide for that}.
