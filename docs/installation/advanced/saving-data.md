...
This approach is only available in the {@link installation/predefined-builds#classic-editor Classic editor} and only if the editor was used to replace a `<textarea>` element:
