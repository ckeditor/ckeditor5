...
`$block` is a generic structural element that may contain textual content. Features like headings or paragraph implement it to to inherit common behaviours. You can read more about it in the {@link framework/guides/deep-dive/schema#generic-items Schema} guide.
