...
* {@link installation/getting-started/quick-start#creating-custom-builds Creating custom builds} which is necessary to have your plugin included inside a CKEditor 5 build.
