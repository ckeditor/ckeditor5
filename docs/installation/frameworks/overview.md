...
3. **If none exists, integrate CKEditor 5 with your framework by yourself.**
	...
	CKEditor 5 offers {@link installation/predefined-builds ready-to-use builds} that expose a {@link installation/getting-started/basic-api rich JavaScript API} which you can use to {@link installation/getting-started/basic-api#creating-an-editor create editors} and {@link installation/getting-started/basic-api#interacting-with-the-editor control them}.
