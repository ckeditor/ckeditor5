...
<info-box warning>
	Starting with the v37.0.0 release, CKEditor 5 has built-in type definitions. Similarly, starting from the 6.0.0 version, the `@ckeditor/ckeditor5-react` package also supports TypeScript.
</info-box>
