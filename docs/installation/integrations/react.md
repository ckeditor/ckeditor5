...
* `disableWatchdog` &ndash; A Boolean value. If set to `true`, [watchdog](https://ckeditor.com/docs/ckeditor5/latest/features/watchdog.html) will be disabled. It is set to `false` by default.
