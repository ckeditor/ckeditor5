...
Introduced new table block alignments, `blockLeft` and `blockRight`, allowing tables to be aligned to the left or right without text wrapping. Two new buttons have been added to the table properties balloon to enable these alignment options.
