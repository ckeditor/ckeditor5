...
![A composition of screenshots presenting various features of CKEditor&nbsp;5 rich text editor](https://github.com/ckeditor/ckeditor5/blob/master/docs/assets/img/CKEditor-5.png)
