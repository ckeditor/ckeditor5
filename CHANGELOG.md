...
* **[real-time-collaboration](https://www.npmjs.com/package/@ckeditor/ckeditor5-real-time-collaboration)**: Collaboration updates will now be sent with smaller delays after they are rejected. This should allow for a better user experience when multiple users are typing at the same time.
...
* **[real-time-collaboration](https://www.npmjs.com/package/@ckeditor/ckeditor5-real-time-collaboration)**: Real-time collaboration feature will now create batches with `#isLocal` flag set to `false`.
