...
* **[comments](https://www.npmjs.com/package/@ckeditor/ckeditor5-comments)**: Comments will now be retained in the clipboard and pasted into the content when the user performs the cut and paste action. To revert to previous behavior (no retaining), set `comments.copyMarkers` configuration property to an empty array.
...
* **[comments](https://www.npmjs.com/package/@ckeditor/ckeditor5-comments)**: Introduced the copy-paste and cut-paste functionalities for comments markers. By default, comment markers will be retained on cut-paste action. See documentation for the new `comments.copyMarkers` configuration property to learn more.
...
* **[core](https://www.npmjs.com/package/@ckeditor/ckeditor5-core)**: Deprecated `DataApiMixin` and moved `setData()` and `getData()` methods directly to the `Editor` class. ([commit](https://github.com/ckeditor/ckeditor5/commit/b1d801d1ec77e8ab82fcd80a08642ca9e04b1b81))
