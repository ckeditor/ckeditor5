...
* **[table](https://www.npmjs.com/package/@ckeditor/ckeditor5-table)**: The `TableNavigation` plugin renamed to `TableKeyboard`.
...
* The functions `getSelectedTableWidget()` and `getTableWidgetAncestor()` from `table/utils` module were moved to `table/utils/widget` module.
...
* The constant `defaultColors` from `table/ui/utils` modules was moved to `table/utils/ui/table-properties` module.
...
* **[link](https://www.npmjs.com/package/@ckeditor/ckeditor5-link)**: Introduced the `config.link.defaultProtocol` option for automatically adding it to the links when it's not provided by the user in the link form. Closes [#4858](https://github.com/ckeditor/ckeditor5/issues/4858). ([commit](https://github.com/ckeditor/ckeditor5/commit/76c762e5a6549cb20de4331046bd324c992e95a0))
...
* **[upload](https://www.npmjs.com/package/@ckeditor/ckeditor5-upload)**: Allowed the `config.simpleUpload.withCredentials` request configuration. Closes [#7282](https://github.com/ckeditor/ckeditor5/issues/7282). ([commit](https://github.com/ckeditor/ckeditor5/commit/5a34216fadebeaf3acc5b88002eec4b841a1b17d))
...
* **[engine](https://www.npmjs.com/package/@ckeditor/ckeditor5-engine)**: Backspace will not change the type of the trailing block. Closes [#6680](https://github.com/ckeditor/ckeditor5/issues/6680). ([commit](https://github.com/ckeditor/ckeditor5/commit/a87b364cce3fc70412031243ea0123333a91b821))
...
* The widget toolbar won't be shown if an empty collection of items was provided in the editor's configuration. Closes [#5857](https://github.com/ckeditor/ckeditor5/issues/5857). ([commit](https://github.com/ckeditor/ckeditor5/commit/64e53153737458bb0e64db16049b581e0ff8aae9))
...
* **[table](https://www.npmjs.com/package/@ckeditor/ckeditor5-table)**: Extracted `TableMouse` plugin from `TableSelection` plugin. Closes [#6757](https://github.com/ckeditor/ckeditor5/issues/6757). ([commit](https://github.com/ckeditor/ckeditor5/commit/4d2f5f9b9f298601b332f304da66333c52673cb8))
  ...
  MINOR BREAKING CHANGE (table): The `TableNavigation` plugin renamed to `TableKeyboard`.
...
* Cleanup the table helper functions API. Closes [#6822](https://github.com/ckeditor/ckeditor5/issues/6822). ([commit](https://github.com/ckeditor/ckeditor5/commit/893b873002c838fb10efda35515ccfaf44c3e39a))
* Upgraded versions of all dependencies. See [#7202](https://github.com/ckeditor/ckeditor5/issues/7202). ([commit](https://github.com/ckeditor/ckeditor5/commit/91cffa8e9cbcee6e7ad57e829e5de6275f06aaa8))
* Minimal version of Node.js has been increased to `12.0.0`. ([commit](https://github.com/ckeditor/ckeditor5/commit/91cffa8e9cbcee6e7ad57e829e5de6275f06aaa8))
* Improved the select-all feature so that it includes more and more content if the selection was anchored in a nested editable. Closes [#6621](https://github.com/ckeditor/ckeditor5/issues/6621). ([commit](https://github.com/ckeditor/ckeditor5/commit/6f59c78eb88335cabf0d39612b40c3b50fade41f))
