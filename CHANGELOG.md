...
* **[track-changes](https://www.npmjs.com/package/@ckeditor/ckeditor5-track-changes)**: Added a more granular changes tracking ([#5226](git+https://github.com/cksource/collaboration-features/issues/5226)).
