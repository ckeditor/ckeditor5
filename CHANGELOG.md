...
| ⚠️&nbsp;&nbsp; **Information for customers which use CKEditor 5 with real-time collaboration and [upload the editor bundles to Cloud Services](https://ckeditor.com/docs/cs/latest/guides/collaboration/editor-bundle.html)** |
| :--- |
