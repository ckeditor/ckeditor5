 ...
 *
 * @param returnHex Optional. If set to true, the checksum is returned as a hexadecimal string. Otherwise, it is returned as a number.
 * @returns The CRC-32 checksum, either as a number or a hexadecimal string if returnHex is true.
 */
export default function crc32( inputData: CRCData, returnHex: boolean = false ): number | string {
