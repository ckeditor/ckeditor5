...
import { RectDrawer, diagonalStylesBlack } from '../../tests/_utils/rectdrawer.js';
...
function drawVisibleRects() {
	...
	const children = Array.from( document.querySelectorAll( '.js-child' ) ) as Array<HTMLElement>;
	const parents = Array.from( document.querySelectorAll( '.js-parent' ) ) as Array<HTMLElement>;
