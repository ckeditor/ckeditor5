...
const translations: Translations = {
	'en-au': {
		dictionary: {
			...
			'Enter the bookmark name without spaces.': 'Enter the bookmark name without spaces.',
			// The error message. Displayed when the bookmark name is empty.
			'Bookmark must not be empty.': 'Bookmark must not be empty.',
			// The error message. Displayed when provided name includes spaces.
			'Bookmark name cannot contain space characters.': 'Bookmark name cannot contain space characters.',
			// The error message. Displayed when provided name already exists.
			'Bookmark name already exists.': 'Bookmark name already exists.',
			...
			'Scroll to bookmark': 'Scroll to bookmark'
		}
	}
};
