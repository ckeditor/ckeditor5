 ...
 */
function removeAlignmentFromSelection( blocks: Array<ModelElement>, writer: Writer ) {
 ...
 */
function setAlignmentOnSelection( blocks: Array<ModelElement>, writer: Writer, alignment: string ) {
	for ( const block of blocks ) {
