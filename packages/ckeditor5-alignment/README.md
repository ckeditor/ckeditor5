...
Check out the [demo in the text alignment feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/text-alignment.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-alignment` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/alignment.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
