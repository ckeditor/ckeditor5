...
<info-box info>
	To learn more about building CKEditor, check out the {@link installation/getting-started/quick-start#creating-custom-builds Creating custom builds guide}.
</info-box>
