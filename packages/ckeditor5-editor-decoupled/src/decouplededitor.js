...
/**
 * The {@glink builds/guides/predefined/overview#document-editor decoupled editor} implementation.
 ...
 * but it is also available in the {@glink builds/guides/predefined/overview#document-editor document editor build}.
 *
...
export default class DecoupledEditor extends Editor {
	 ...
	 * {@glink builds/guides/predefined/overview editor build} (for example – `@ckeditor/ckeditor5-build-decoupled`).
	 *
