...
<info-box>
	See the {@link getting-started/legacy-getting-started/predefined-builds#document-editor Predefined builds guide} to learn how to install the document editor build.
</info-box>
