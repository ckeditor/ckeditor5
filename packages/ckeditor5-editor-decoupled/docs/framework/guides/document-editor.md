...
<info-box>
	See the {@link installation/quick-start#document-editor Quick start guide} to learn how to install the document editor build.
</info-box>
