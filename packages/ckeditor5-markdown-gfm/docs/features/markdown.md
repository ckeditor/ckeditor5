...
The {@link module:markdown-gfm/gfmdataprocessor~GFMDataProcessor} class implements a {@link module:engine/dataprocessor/dataprocessor~DataProcessor data processor} which changes CKEditor output from HTML to Markdown. This means that you can {@link module:core/editor/utils/datainterface~DataInterface#setData set} or {@link module:core/editor/utils/datainterface~DataInterface#getData get} data from the editor in the Markdown format:
