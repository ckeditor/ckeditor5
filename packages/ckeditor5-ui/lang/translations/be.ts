...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Click to edit block': 'Націсніце, каб рэдагаваць блок',
			...
			'Editor block content toolbar': 'Панэль інструментаў рэдактара',
			// Accessible label of a balloon toolbar that shows up right next to the user selection (the caret).
			'Editor contextual toolbar': 'Кантэкстуальная панэль інструментаў рэдактара',
			...
			'Help Contents. To close this dialog press ESC.': 'Змест дапамогі. Каб закрыць гэта дыялогавае акно, націсніце ESC.',
			// Accessibility help dialog text explaining what can be found in that dialog.
			'Below, you can find a list of keyboard shortcuts that can be used in the editor.': 'Ніжэй вы можаце знайсці спіс камбінацый клавіш, якія можна выкарыстоўваць у рэдактары.',
			// Accessibility help dialog text displayed next to keystrokes that may require the Fn key on Mac.
			'(may require <kbd>Fn</kbd>)': '(можа патрабаваць <kbd>Fn</kbd>)',
			...
			'Accessibility help': 'Дапамога па спецыяльных магчымасцях',
			...
			'Press %0 for help.': 'Націсніце %0 для атрымання дапамогі.',
			// Keystroke description for assistive technologies: keystroke for moving focus out of an active dialog window.
			'Move focus in and out of an active dialog window': 'Перамясціць фокус у актыўнае дыялогавае акно і наадварот.',
