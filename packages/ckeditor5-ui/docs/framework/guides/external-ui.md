...
Once everything works as expected, you may want to create a custom build of your editor to ship it across the applications. To learn more check out the {@link installation/getting-started/quick-start#creating-custom-builds Creating custom builds guide}.
