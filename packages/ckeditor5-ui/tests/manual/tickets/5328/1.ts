...
ClassicEditor
	.create( {
		attachTo: document.querySelector( '#editor-stick' ) as HTMLElement,
		image: {
	...
	.then( editor => {
		...
		panel.pin( {
			target: editor.ui.view.element!.querySelector( '.ck-editor__editable p strong' ) as HTMLElement,
...
ClassicEditor
	.create( {
		attachTo: document.querySelector( '#editor-with-scroll' ) as HTMLElement,
		image: {
			toolbar: [ 'imageStyle:inline', 'imageStyle:block', 'imageStyle:wrapText', '|', 'imageTextAlternative' ]
		},
		plugins: [ ArticlePluginSet, TableToolbar, TableCaption, TableCellProperties, TableColumnResize, TableProperties ],
...
ClassicEditor
	.create( {
		attachTo: document.querySelector( '#editor-out-of-the-box' ) as HTMLElement,
		image: {
			toolbar: [ 'imageStyle:inline', 'imageStyle:block', 'imageStyle:wrapText', '|', 'imageTextAlternative' ]
		},
		plugins: [ ArticlePluginSet, TableToolbar, TableCaption, TableCellProperties, TableColumnResize, TableProperties ],
