...
| Style feature | {@link framework/guides/architecture/core-editor-architecture#commands Command} name | {@link features/toolbar-setup Toolbar} component name | Output element |
|-----|---|-----|-----|
