...
Check out the [demo in the basic styles feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/basic-styles.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-basic-styles` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/basic-styles.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
