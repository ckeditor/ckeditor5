...
<info-box>
	Currently, the source editing mode is supported in the {@link examples/builds/classic-editor classic editor}. The source editing feature is not compatible with {@link features/real-time-collaboration CKEditor 5 real-time collaboration features}, but it can be used with {@link features/collaboration#non-real-time-collaboration non real-time collaboration}. If you would like to use collaboration features, but for some reason you would like to also enable source editing, please [contact us](https://ckeditor.com/contact/).
</info-box>
