...
Check out the [demo in the source code editing feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/source-editing/source-editing.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-source-editing` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/source-editing.html) page as well as the [source editing feature](https://ckeditor.com/docs/ckeditor5/lts-v47/features/source-editing/source-editing.html) guide in the [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
