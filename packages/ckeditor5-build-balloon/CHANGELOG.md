...
* Changed the URL under bugs key in package.json file. Now we have one issue tracker. See [ckeditor/ckeditor5#1988](https://github.com/ckeditor/ckeditor5/issues/1988). ([37be904](https://github.com/ckeditor/ckeditor5-build-balloon/commit/37be904))
