...
<info-box warning>
	The {@link module:list/liststyle~ListProperties} feature overrides UI button implementations from the {@link module:list/listui~ListUI}.
</info-box>
...
The {@link module:list/liststyle~ListProperties} plugin registers:
