...
export default class DocumentListPropertiesEditing extends Plugin {
	...
	init() {
		...
		// this.listenTo( editor.commands.get( 'indentList' ), 'afterExecute', fixListAfterIndentListCommand( editor, strategies ) );
		// this.listenTo( editor.commands.get( 'outdentList' ), 'afterExecute', fixListAfterOutdentListCommand( editor, strategies ) );
		//
		// this.listenTo( editor.commands.get( 'bulletedList' ), 'afterExecute', restoreDefaultListStyle( editor ) );
		// this.listenTo( editor.commands.get( 'numberedList' ), 'afterExecute', restoreDefaultListStyle( editor ) );
		//
