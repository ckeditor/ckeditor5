...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-a' ) as HTMLElement,
		list: {
			properties: {
				styles: true,
				startIndex: true,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-b' ) as HTMLElement,
		list: {
			properties: {
				styles: true,
				startIndex: true,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-c' ) as HTMLElement,
		list: {
			properties: {
				styles: true,
				startIndex: false,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-d' ) as HTMLElement,
		list: {
			properties: {
				styles: false,
				startIndex: true,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-e' ) as HTMLElement,
		list: {
			properties: {
				styles: false,
				startIndex: true,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-f' ) as HTMLElement,
		list: {
			properties: {
				styles: false,
				startIndex: false,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-g' ) as HTMLElement,
		list: {
			properties: {
				styles: true,
				startIndex: false,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-h' ) as HTMLElement,
		list: {
			properties: {
				styles: false,
				startIndex: false,
...
ClassicEditor
	.create( {
		...config,
		attachTo: document.querySelector( '#editor-i' ) as HTMLElement,
		menuBar: {
			isVisible: true
		},
		list: {
