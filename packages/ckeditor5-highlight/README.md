...
Check out the [demo in the highlight feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/highlight.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-highlight` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/highlight.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
