...
Check out the [demo in the heading feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/headings.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-heading` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/heading.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
