...
See the [`@ckeditor/ckeditor5-upload` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/upload.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
