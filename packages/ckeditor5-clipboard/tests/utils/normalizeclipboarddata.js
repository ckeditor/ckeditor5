...
describe( 'normalizeClipboardData()', () => {
	...
	it( 'should not strip spans with no attributes if they contain anything but spaces', () => {
		...
		).toBe( '<span> a</span>x<span>b\u00a0</span>x<span>c</span>' );
	} );
