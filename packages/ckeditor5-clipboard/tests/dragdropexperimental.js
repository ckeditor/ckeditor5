...
describe( 'Drag and Drop experimental', () => {
	...
	it( 'requires DragDropTarget, ClipboardPipeline and Widget', () => {
		expect( DragDropExperimental.requires ).to.deep.equal( [ ClipboardPipeline, Widget, DragDropTarget ] );
	} );

	it( 'has proper name', () => {
		expect( DragDropExperimental.pluginName ).to.equal( 'DragDropExperimental' );
	} );
		...
		beforeEach( () => {
			...
			return ClassicTestEditor
				.create( editorElement, {
					plugins: [ Paragraph, WidgetToolbarRepository, DragDropExperimental, HorizontalLine ]
				} )
				.then( newEditor => {
					editor = newEditor;
