...
If you are not familiar with creating plugins in CKEditor&nbsp;5, it is recommended to start from reading the tutorials/crash-course/editor Creating a simple plugin} guide to get a better understanding of what happens in the code below.
