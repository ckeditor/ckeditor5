...
describe( 'Mention feature - integration', () => {
	...
	describe( 'with undo', () => {
		...
		it( 'should restore removed mention on adding a text inside mention', () => {
			...
			expect( _getViewData( editor.editing.view, { withoutSelection: true } ) )
				.to.equal( '<p>foo <span class="mention" data-mention="@John" data-uid="u1">@John</span> bar</p>' );
		} );
		...
		it( 'should work with attribute post-fixer (beginning formatted)', () => {
			testAttributePostFixer(
				'<p>foo <span class="mention" data-mention="@John" data-uid="u1">@John</span> bar</p>',
				'<p><strong>foo <span class="mention" data-mention="@John" data-uid="u1">@John</span></strong> bar</p>',
				() => {
					model.change( writer => {
						const paragraph = doc.getRoot().getChild( 0 );
		...
		it( 'should work with attribute post-fixer (end formatted)', () => {
			testAttributePostFixer(
				'<p>foo <span class="mention" data-mention="@John" data-uid="u1">@John</span> bar</p>',
				'<p>foo <strong><span class="mention" data-mention="@John" data-uid="u1">@John</span> ba</strong>r</p>',
				() => {
					model.change( writer => {
						const paragraph = doc.getRoot().getChild( 0 );
		...
		it( 'should work with attribute post-fixer (middle formatted)', () => {
			testAttributePostFixer(
				'<p>foo <span class="mention" data-mention="@John" data-uid="u1">@John</span> bar</p>',
				'<p>foo <strong><span class="mention" data-mention="@John" data-uid="u1">@John</span></strong> bar</p>',
				() => {
					model.change( writer => {
						const paragraph = doc.getRoot().getChild( 0 );
						const start = writer.createPositionAt( paragraph, 6 );
	...
	describe( 'with clipboard', () => {
		...
		it( 'should generate new uid when pasting mention copied from the editor', () => {
			editor.setData( '<p><span class="mention" data-mention="@John" data-uid="u1">@John</span> foobar</p>' );
			...
			// The clipboard HTML should not contain data-uid.
			const clipboardHtml = dataTransferMock.setData.firstCall.args[ 1 ];

			expect( clipboardHtml ).to.not.include( 'data-uid' );
			...
			expect( () => {
				editor.setData(
					'<figure class="table"><table><tbody><tr><td>' +
						'<span class="mention" data-mention="@Barney" data-uid="u1">@Barney</span> ' +
						'<span class="mention" data-mention="@Barney" data-uid="u2">@Barney</span>' +
