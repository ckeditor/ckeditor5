...
export default class MentionCommand extends Command {
	 ...
	 * @param {module:engine/model/range~Range} [options.range] The range to replace. Note that the replaced range might be shorter than the inserted text with the
	 * mention attribute.
	 * @fires execute
	 */
	execute( options ) {
