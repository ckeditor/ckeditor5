...
import { BubblingEventInfo, ObserverDomEventData, type ViewDocumentKeyDownEvent } from '@ckeditor/ckeditor5-engine';
	...
	public init(): void {
		...
		this.listenTo<ViewDocumentKeyDownEvent>( viewDocument, 'keydown', ( evt, data ) => {
			...
			if ( limitStartPosition.isTouching( modelDocument.selection.getFirstPosition()! ) ) {
				...
				viewDocument.fire( eventInfo, new ObserverDomEventData( view, data.domEvent, deleteData ) );
			}
		} );
