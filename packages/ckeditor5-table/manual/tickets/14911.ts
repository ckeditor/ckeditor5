...
function generateExample( number: number, table: string ) {
	return `
...
async function createTableInPre( number: number, table: string, target: string ) {
	let divForExample: string;
	switch ( target ) {
		case 'ghs':
...
function createEditor( number: number, table: string, type: string ) {
