...
import { TableCellPropertiesViewExperimental } from '../../../src/tablecellproperties/ui/tablecellpropertiesviewexperimental.js';
			...
			describe( 'form rows', () => {
				...
				describe( 'action row', () => {
					...
					it( 'should be defined [experimental]', () => {
						const row = experimentalView.element.childNodes[ 5 ];
