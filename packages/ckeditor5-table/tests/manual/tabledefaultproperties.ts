...
const styleAsPlainText = ( document.querySelector( '#table-properties-styles' ) as HTMLElement ).innerText
	.trim()
	.split( '\n' )
	.map( line => line.replace( /^\t/, '' ) )
	.join( '\n' );

( document.querySelector( '#table-properties-styles-preview' ) as HTMLElement ).innerText = styleAsPlainText;
