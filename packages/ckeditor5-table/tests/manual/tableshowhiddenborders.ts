...
const sourceElementWithHiddenBorders = document.querySelector( '#editor-with-show-hidden-borders' ) as HTMLElement;
const sourceElementWithoutHiddenBorders = document.querySelector( '#editor-without-show-hidden-borders' ) as HTMLElement;
