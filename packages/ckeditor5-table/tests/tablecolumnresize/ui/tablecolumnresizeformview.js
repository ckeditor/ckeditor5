...
import TableColumnResizeFormView from '../../../src/tablecolumnresize/ui/tablecolumnresizeformview.js';
...
describe( 'TableColumnResizeFormView', () => {
	let view;

	testUtils.createSinonSandbox();

	beforeEach( () => {
		view = new TableColumnResizeFormView( { t: () => {} } );
	} );
	...
	describe( 'constructor()', () => {
		it( 'should create element from template', () => {
			...
			expect( view.element.classList.contains( 'ck-resize-column-form' ) ).to.be.true;
	...
	describe( 'isValid()', () => {
		it( 'should reset error after successful validation', () => {
			const view = new TableColumnResizeFormView( { t: () => {} }, [
				() => undefined
			] );
		...
		it( 'should pass view reference as argument to validator', () => {
			...
			const view = new TableColumnResizeFormView( { t: () => {} }, [ validatorSpy ] );
