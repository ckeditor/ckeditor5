---
menu-title: Basic table feature
category: tables
order: 20
...
<info-box>
    If you would like to block the possibility to nest tables in your editor, see the {@link features/tables-basic#disallow-nesting-tables Disallow nesting tables} section to learn how to disable this functionality.
</info-box>
