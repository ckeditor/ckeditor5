...
/**
 * @module table/utils/tableselectionutils
 */
...
/**
 * The table selection utilities plugin.
 *
 * @extends module:core/plugins~Plugin
 */
export default class TableSelectionUtils extends Plugin {
	/**
	 * @inheritDoc
	 */
	static get pluginName() {
		return 'TableSelectionUtils';
	}
