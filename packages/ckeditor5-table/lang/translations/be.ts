...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Table toolbar': 'Панель інструментаў табліцы',
			...
			'Cell properties': 'Уласцівасці ячэйкі',
			...
			'Table cell text alignment': 'Выраўнаванне тэксту ў ячэйцы табліцы',
			...
			'Horizontal text alignment toolbar': 'Панель інструментаў выраўнавання тэксту па гарызанталі',
			...
			'Vertical text alignment toolbar': 'Панель інструментаў выраўнавання тэксту па вертыкалі',
			// The label used by assistive technologies describing a toolbar that allows configuring the alignment of a table.
			'Table alignment toolbar': 'Панель інструментаў выраўнавання табліцы',
