...
const translations: Translations = {
	'en-au': {
		dictionary: {
			...
			'Insert table layout': 'Insert table layout',
			...
			'Align table to the left with text wrapping': 'Align table to the left with text wrapping',
			...
			'Center table with no text wrapping': 'Center table with no text wrapping',
			...
			'Align table to the right with text wrapping': 'Align table to the right with text wrapping',
			...
			'Align table to the left with no text wrapping': 'Align table to the left with no text wrapping',
			...
			'Align table to the right with no text wrapping': 'Align table to the right with no text wrapping',
			...
			'Choose table type': 'Choose table type',
			...
			'Table type options': 'Table type options'
		}
	}
};
