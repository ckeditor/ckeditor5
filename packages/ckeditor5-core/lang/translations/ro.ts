...
const translations: Translations = {
	'ro': {
		dictionary: {
			...
			'Please try a different phrase or check the spelling.': 'Vă rugăm să încercați o altă expresie sau verificați ortografia.',
		...
		getPluralForm: ( n: number ) => (n == 1 ? 0 : (n == 0 || (n % 100 > 0 && n % 100 < 20)) ? 1 : 2)
	}
};
