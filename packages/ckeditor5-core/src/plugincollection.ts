...
export default class PluginCollection<TContext extends object> extends EmitterMixin() implements Iterable<PluginEntry<TContext>> {
	...
	public init(
		...
		function checkMissingPlugin(
			 ...
			 * property.
			 *
			 * **If you see this warning when using one of the {@glink installation/legacy/legacy-getting-started/predefined-builds
			 * CKEditor 5 Builds}**,
			 ...
			 * read more about {@glink installation/legacy/legacy-getting-started/quick-start custom builds}.
			 *
			 ...
			 * {@glink installation/legacy/advanced/alternative-setups/integrating-from-source-webpack "Building from source"}.
			 *
	...
	private _add( PluginConstructor: PluginConstructor<TContext>, plugin: PluginInterface ) {
		...
		if ( this._plugins.has( pluginName ) ) {
			 ...
			 *
			 * Read more about {@glink framework/plugins/installing-plugins Installing plugins}.
			 *
