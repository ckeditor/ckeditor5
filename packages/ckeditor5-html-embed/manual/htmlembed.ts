...
async function startMode() {
	...
	const [ uiLanguage, contentLanguage ] = ( document.querySelector( 'input[name="language"]:checked' ) as HTMLInputElement )
		.value.split( '-' );
...
async function startEnabledPreviewsMode( config: any ) {
	await reloadEditor( {
		...config,
		htmlEmbed: {
			showPreviews: true,
...
async function startDisabledPreviewsMode( config: any ) {
...
function getSanitizeHtmlConfig( defaultConfig: any ) {
