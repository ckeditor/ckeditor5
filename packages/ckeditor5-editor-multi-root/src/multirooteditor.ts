...
/**
 * The {@glink installation/legacy/legacy-getting-started/predefined-builds#multi-root-editor multi-root editor} implementation.
 *
 ...
 * {@glink installation/legacy/legacy-getting-started/predefined-builds#multi-root-editor multi-root editor build}.
 *
 * {@glink installation/legacy/legacy-getting-started/predefined-builds Builds} are ready-to-use editors with plugins bundled in.
 *
