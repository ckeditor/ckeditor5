...
export default class Widget extends Plugin {
	...
	_handleArrowKeys( isForward ) {
		...
		if ( objectElement && schema.isObject( objectElement.name ) ) {
		...
		if ( objectElement2 instanceof ModelElement && schema.isObject( objectElement2.name ) ) {
			model.change( () => {
	...
	_getObjectElementNextToSelection( forward ) {
		...
		if ( objectElement instanceof ModelElement && schema.isObject( objectElement.name ) ) {
