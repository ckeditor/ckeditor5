...
## [19.0.0](https://github.com/ckeditor/ckeditor5-build-classic/compare/v18.0.0...v19.0.0) (2020-04-28)

### Other changes

* The inline `style` element which is being produced by Webpack and delivers styles for the editor will have the `[data-cke="true"]` attribute in order to help find CKEditor 5 styles. See [ckeditor/ckeditor5#6454](https://github.com/ckeditor/ckeditor5/issues/6454). ([20f2a31](https://github.com/ckeditor/ckeditor5-build-classic/commit/20f2a31))
