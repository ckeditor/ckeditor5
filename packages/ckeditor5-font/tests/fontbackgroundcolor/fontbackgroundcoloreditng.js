...
describe( 'FontBackgroundColorEditing', () => {
	...
	describe( 'config', () => {
		describe( 'default value', () => {
			it( 'should be set', () => {
				expect( editor.config.get( 'fontBackgroundColor.colors' ) ).toEqual( defaultColors );
				expect( editor.config.get( 'fontBackgroundColor.columns' ) ).toEqual( defaultColorGridColumns );
			} );
		} );
	} );
