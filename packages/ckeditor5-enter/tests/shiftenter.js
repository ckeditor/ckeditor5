...
describe( 'ShiftEnter feature', () => {
	...
	it( 'listens to the editing view enter event', () => {
		...
		viewDocument.fire( 'enter', new ObserverDomEventData( viewDocument, domEvt, { isSoft: true } ) );
	...
	it( 'does not execute the command if hard enter should be used', () => {
		...
		viewDocument.fire( 'enter', new ObserverDomEventData( viewDocument, domEvt, { isSoft: false } ) );
