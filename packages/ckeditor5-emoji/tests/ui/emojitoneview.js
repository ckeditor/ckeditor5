	...
	describe( '#dropdownView', () => {
		...
		describe( '#buttonView', () => {
			...
			it( 'does not use the `[aria-labelled-by]` attribute as the button is descriptive enough', () => {
				...
				expect( emojiToneView.dropdownView.buttonView.ariaLabelledBy ).toBeUndefined();
			} );
		...
		describe( '#listView', () => {
			it( 'does not use the `[aria-labelled-by]` attribute as the button is descriptive enough for all items', () => {
				...
				expect( listItems[ 0 ].children.first.ariaLabelledBy ).toBeUndefined();
				...
				expect( listItems[ 1 ].children.first.ariaLabelledBy ).toBeUndefined();
				...
				expect( listItems[ 2 ].children.first.ariaLabelledBy ).toBeUndefined();
				...
				expect( listItems[ 3 ].children.first.ariaLabelledBy ).toBeUndefined();
				...
				expect( listItems[ 4 ].children.first.ariaLabelledBy ).toBeUndefined();
				...
				expect( listItems[ 5 ].children.first.ariaLabelledBy ).toBeUndefined();
			} );
		} );
	} );
} );
