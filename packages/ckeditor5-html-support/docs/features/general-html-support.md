...
* {@link features/full-page-html Full Page HTML} &ndash; It keeps the elements that are usually not visible to the user - like the head tag - in the editor's data. Combining these two plugins allows you to edit the source of the whole HTML page.
