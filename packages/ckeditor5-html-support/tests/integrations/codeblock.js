...
describe( 'CodeBlockElementSupport', () => {
	...
	describe( 'attributes modifications', () => {
		...
		describe( 'on the <pre> element', () => {
			...
			it.skip( 'should add new classes', () => {
				editor.setData( '<pre><code>foobar</code></pre>' );
			...
			it.skip( 'should add new attributes', () => {
				editor.setData( '<pre><code>foobar</code></pre>' );
			...
			it.skip( 'should remove some styles', () => {
			...
			it.skip( 'should remove some classes', () => {
			...
			it.skip( 'should remove some attributes', () => {
			...
			it.skip( 'should remove some classes, styles and attributes', () => {
				editor.setData(
				...
				expect( editor.getData() ).toBe(
					'<pre class="foo" style="background-color:blue;" data-foo="bar">' +
						'<code class="language-plaintext">foobar</code>' +
					'</pre>'
				);
			} );

			it.skip( 'should remove all classes, styles and attributes', () => {
				editor.setData(
					'<pre class="foo bar" style="background-color:blue;color:red;" data-foo="bar" data-bar="baz">' +
						'<code>foobar</code>' +
					'</pre>'
