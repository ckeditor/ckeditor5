...
Check out the demo in the [undo/redo feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/undo-redo.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-undo` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/undo.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
