...
Check out the [demo in the autoformat feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/autoformat.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-autoformat` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/autoformat.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
