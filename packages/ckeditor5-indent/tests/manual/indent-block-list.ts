...
const controls = {
	ghs: document.querySelector( '#ghs' ) as HTMLInputElement,
	pfo: document.querySelector( '#pfo' ) as HTMLInputElement,
	indent: document.querySelector( '#indent' ) as HTMLInputElement,
	indentBlock: document.querySelector( '#indentBlock' ) as HTMLInputElement,
	list: document.querySelector( '#list' ) as HTMLInputElement,
	listProperties: document.querySelector( '#listProperties' ) as HTMLInputElement,
	useClasses: document.querySelector( '#useClasses' ) as HTMLInputElement
};
...
function getEditorConfig() {
	const plugins: Array<PluginConstructor> = [
	...
	( config as any ).indentBlock = controls.useClasses!.checked ? { classes: [ 'indent-1', 'indent-2', 'indent-3', 'indent-4' ] } : {};
