...
Check out the demo in the [link feature guide](https://ckeditor.com/docs/ckeditor5/lts-v47/features/link.html#demo).

## Documentation

See the [`@ckeditor/ckeditor5-link` package](https://ckeditor.com/docs/ckeditor5/lts-v47/api/link.html) page in [CKEditor&nbsp;5 documentation](https://ckeditor.com/docs/ckeditor5/lts-v47/).
