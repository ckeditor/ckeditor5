...
/**
 * The {@glink builds/guides/predefined/overview#balloon-editor balloon editor} implementation (Medium-like editor).
 ...
 * but it is also available in the {@glink builds/guides/predefined/overview#balloon-editor balloon build}.
 *
 * {@glink builds/guides/predefined/overview Builds} are ready-to-use editors with plugins bundled in. When using the editor from
...
export default class BalloonEditor extends Editor {
	 ...
	 * {@glink builds/guides/predefined/overview editor build} (for example – `@ckeditor/ckeditor5-build-balloon`).
	 *
