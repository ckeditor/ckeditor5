...
/**
 * The {@glink builds/guides/predefined/overview#inline-editor inline editor} implementation.
 ...
 * but it is also available in the {@glink builds/guides/predefined/overview#inline-editor inline build}.
 *
...
export default class InlineEditor extends Editor {
	 ...
	 * {@glink builds/guides/predefined/overview editor build} (for example – `@ckeditor/ckeditor5-build-inline`).
	 *
