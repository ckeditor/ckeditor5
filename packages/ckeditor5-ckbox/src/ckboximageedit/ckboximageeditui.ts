...
/**
 * @module ckbox/ckboximageedit/imageiditui
 */
 ...
 *
 * It registers the `'imageEdit'` UI button in the editor's {@link module:ui/componentfactory~ComponentFactory component factory}
