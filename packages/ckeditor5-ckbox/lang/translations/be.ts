...
const translations: Translations = {
	'be': {
		dictionary: {
			...
			'Open file manager': 'Адкрыць менеджэр файлаў',
			...
			'Cannot determine a category for the uploaded file.': 'Немагчыма вызначыць катэгорыю для запампаванага файла.',
			// A message is displayed when the user is not authorised to access the CKBox workspace configured as default one.
			'Cannot access default workspace.': 'Немагчыма атрымаць доступ да прадвызначанай працоўнай прасторы.',
			// The title of the notification displayed when there is no permission to edit assets.
			'You have no image editing permissions.': 'У вас няма дозволу на рэдагаванне відарыса.',
			...
			'Processing the edited image.': 'Апрацоўка адрэдагаванага відарыса.',
			// A message is displayed when the server fails to process an image or doesn't respond.
			'Server failed to process the image.': 'Сервер не здольны апрацаваць відарыс.',
			// A message is displayed when category of the image user wants to edit can't be determined.
			'Failed to determine category of edited image.': 'Не здольны вызначыць катэгорыю адрэдагаванага відарыса.'
		}
	}
};
