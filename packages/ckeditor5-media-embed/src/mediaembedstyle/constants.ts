...
import type { MediaStyleDropdownDefinition, MediaStyleOptionDefinition } from '../mediaembedconfig.js';

/**
 * The name of the default media style. When applied, no `mediaStyle` attribute
 * is present on the model element (default state = attribute-absence).
 *
 * @internal
 */
export const DEFAULT_STYLE_NAME = 'alignCenter';
 ...
 * @internal
 */
export const DEFAULT_OPTIONS: Record<string, MediaStyleOptionDefinition> = {
	alignLeft: {
		name: 'alignLeft',
