...
menu-title: Styling non-previewable media
meta-title: Styling non-previewable media | CKEditor 5 Documentation
meta-description: Create dedicated styles for non-previewable media providers (e.g. Facebook, Instagram) to help users identify them in the editor content.
order: 60
---
