...
If the image is included into the content with the VML syntax (like this one: `<v:shape><v:imagedata src="...."/></v:shape>`) it will not be pasted either, as this notation is not yet supported by CKEditor 5. If you'd like to see this feature implemented, add a 👍&nbsp; reaction to [this GitHub issue](https://github.com/ckeditor/ckeditor5/issues/9245).
