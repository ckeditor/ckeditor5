...
const roots = {
	intro: { element: document.querySelector( '#editor-intro' ) as HTMLElement },
	content: { element: document.querySelector( '#editor-content' ) as HTMLElement },
	outro: { element: document.querySelector( '#editor-outro' ) as HTMLElement }
};
