...
describe("FindAndReplaceFormEditing", () => {
  ...
  beforeEach(async () => {
    editor = await DecoupledEditor.create("", {
      plugins: [Essentials, Paragraph, BoldEditing, FindAndReplaceFormEditing],
    });

    model = editor.model;
    root = model.document.getRoot();

    findAndReplace = editor.plugins.get("FindAndReplaceForm");
  });
