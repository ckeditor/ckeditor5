...
In order to do so, you can register a converter by using the `attributeToElement()` conversion helper:
...
You can use the `elementToStructure()` conversion helper for this purpose:
