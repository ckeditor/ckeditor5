...
Conversion helpers are functions that let you define how custom HTML markup is converted between the model and the view, without writing low-level converters.

The editor supports a vast amount of the most commonly used HTML elements via {@link features/index existing editor features} out-of-the-box. If your aim is to easily enable common HTML features that are not explicitly supported by the dedicated CKEditor&nbsp;5 features, use the {@link features/general-html-support General HTML Support feature}.
