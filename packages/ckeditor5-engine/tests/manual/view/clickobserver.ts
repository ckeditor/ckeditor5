...
class ClickObserver1 extends DomEventObserver<'click'> {
	declare public id: number;
	declare public domEventType: 'click';
	...
	public onDomEvent( domEvt: MouseEvent ): void {
		this.fire( 'click', domEvt, { id: this.id } );
	}
}

class ClickObserver2 extends DomEventObserver<'click'> {
	declare public id: number;
	declare public domEventType: 'click';
