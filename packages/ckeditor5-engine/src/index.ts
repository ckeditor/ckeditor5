...
// Model.
export { default as DocumentSelection, type DocumentSelectionChangeRangeEvent } from './model/documentselection.js';
...
export type { default as Node } from './model/node.js';
...
export type { default as ViewElementDefinition } from './view/elementdefinition.js';
