...
* [@ckeditor/ckeditor5-easy-image](https://www.npmjs.com/package/@ckeditor/ckeditor5-easy-image): [v1.0.0-alpha](https://github.com/ckeditor/ckeditor5-easy-image/releases/tag/v1.0.0-alpha.1-alpha)
