...
const editors = [
	{
		...
		config: commonConfig,
		data: '<p><img src="/images/game_boy.jpg" alt=""></p>'
	},
	{
		id: 'inline2',
		title: '[Inline] natural size | width + height attributes: Resize in %',
		config: commonConfig,
		data: '<p><img src="/images/game_boy.jpg" alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline3',
		title: '[Inline] natural size | width + height attributes: Resized (width % style)',
		config: commonConfig,
		data: '<p><img style="width:22.69%;" src="/images/game_boy.jpg" alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline4',
		title: '[Inline] natural size | width + height attributes: Resized (width % style)',
		config: commonConfig,
		data: '<p><img class="image_resized" style="width:22.69%;" src="/images/game_boy.jpg" alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline5',
	...
	},
	{
		...
		config: configPx,
		data: '<p><img class="image_resized" style="width:307px;" src="/images/game_boy.jpg" alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline7',
		title: '[Inline] natural size | width + height attributes: Resized (width and height px style)',
		config: configPx,
		data: '<p><img style="height:400px;width:307px;" src="/images/game_boy.jpg" alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline8',
		title: '[Inline] natural size | styles only (w/o width & height attributes): Resize in %',
		config: commonConfig,
		data: '<p><img style="width:384px;height:500px;" src="/images/game_boy.jpg" alt=""></p>'
	},
	{
		id: 'inline9',
		title: '[Inline] natural size | only resize in % (only width style)',
		config: commonConfig,
		data: '<p><img class="image_resized" style="width:12.34%;" src="/images/game_boy.jpg" alt=""></p>'
	},
	{
		id: 'inline10',
	...
	},
	{
		...
		config: commonConfig,
		data: '<p><img src="/images/game_boy.jpg" alt="" width="500" height="500"></p>'
	},
	{
		id: 'inline12',
		title: '[Inline] broken aspect ratio | styles only (w/o width & height attributes)',
		config: commonConfig,
		data: '<p><img style="width:500px;height:500px;" src="/images/game_boy.jpg" alt=""></p>'
	},
	{
		id: 'block1',
		title: '[Block] plain (no attributes, no styles)',
		config: commonConfig,
		data: '<figure class="image"><img src="/images/game_boy.jpg" alt=""></figure>'
	},
	{
		id: 'block2',
		title: '[Block] natural size | width + height attributes: Resize in %',
		config: commonConfig,
		data: '<figure class="image"><img src="/images/game_boy.jpg" width="384" height="500" alt=""></figure>'
	},
	{
		id: 'block3',
		title: '[Block] natural size | width + height attributes: Resized (width % style)',
		config: commonConfig,
		data: '<figure class="image" style="width:10.09%;"><img src="/images/game_boy.jpg" alt="" width="384" height="500"></figure>'
	},
	{
		id: 'block4',
		title: '[Block] natural size | width + height attributes: Resized (width % style)',
		...
		data: '<figure class="image image_resized" style="width:10.09%;">' +
			'<img src="/images/game_boy.jpg" alt="" width="384" height="500"></figure>'
	},
	{
		id: 'block5',
	...
	},
	{
		...
		config: commonConfig,
		data: '<figure class="image" style="width:384px;height:500px;"><img src="/images/game_boy.jpg" alt=""></figure>'
	},
	{
		id: 'block9',
		title: '[Block] natural size | only resize in % (only width style)',
		config: commonConfig,
		data: '<figure class="image image_resized" style="width:19.21%;"><img src="/images/game_boy.jpg" alt=""></figure>'
	},
	{
		id: 'block10',
	...
	},
	{
		...
		config: commonConfig,
		data: '<figure class="image"><img src="/images/game_boy.jpg" width="500" height="500" alt=""></figure>'
	},
	{
		id: 'block12',
		title: '[Block] broken aspect ratio | styles only (w/o width & height attributes)',
		config: commonConfig,
		data: '<figure class="image" style="width:500px;height:500px;"><img src="/images/game_boy.jpg" alt=""></figure>'
	},
	{
		id: 'inline101',
		title: '[Inline] natural size | width + height attributes: Resized (height % style)',
		config: commonConfig,
		data: '<p><img style="height:20%;" src="/images/parrot_2.jpg" alt="" width="300" height="451"></p>'
	},
	{
		id: 'inline102',
		title: '[Inline] natural size | width + height attributes: Resized (height px style)',
		config: configPx,
		data: '<p><img style="height:200px;" src="/images/parrot_2.jpg" alt="" width="300" height="451"></p>'
	},
	{
		id: 'inline103',
		title: '[Inline] natural size | only resize in % (only height style)',
		config: commonConfig,
		data: '<p><img style="height:20%;" src="/images/parrot_2.jpg" alt=""></p>'
	},
	{
		id: 'inline104',
		title: '[Inline] natural size | only resize in px (only height style)',
		config: configPx,
		data: '<p><img style="height:200px;" src="/images/parrot_2.jpg" alt=""></p>'
	},
	{
		id: 'inline105',
		title: '[Inline] width + height attributes: Resized (height & width % style)',
		config: commonConfig,
		data: '<p><img style="width:20%;height:20%;" src="/images/parrot_2.jpg" alt="" width="300" height="451"></p>'
	},
	{
		id: 'inline106',
		title: '[Inline] only resize in % (height & width % style)',
		config: commonConfig,
		data: '<p><img style="width:20%;height:20%;" src="/images/parrot_2.jpg" alt=""></p>'
	},
	{
		id: 'block101',
		title: '[Block] natural size | width + height attributes: Resized (height % style)',
		config: commonConfig,
		data: '<figure class="image" style="height:20%;"><img src="/images/parrot_2.jpg" alt="" width="300" height="451"></figure>'
	},
	{
		id: 'block102',
		title: '[Block] natural size | width + height attributes: Resized (height px style)',
		config: configPx,
		data: '<figure class="image" style="height:200px;"><img src="/images/parrot_2.jpg" alt="" width="300" height="451"></figure>'
	},
	{
		id: 'block103',
		title: '[Block] natural size | only resize in % (only height style)',
		config: commonConfig,
		data: '<figure class="image" style="height:20%;"><img src="/images/parrot_2.jpg" alt=""></figure>'
	},
	{
		id: 'block104',
		title: '[Block] natural size | only resize in px (only height style)',
		config: configPx,
		data: '<figure class="image" style="height:200px;"><img src="/images/parrot_2.jpg" alt=""></figure>'
	},
	{
		id: 'block105',
		...
		data: '<figure class="image" style="width:20%;height:20%;">' +
			'<img src="/images/parrot_2.jpg" alt="" width="300" height="451"></figure>'
	},
	{
		id: 'block106',
		title: '[Block] only resize in % (height & width % style)',
		config: commonConfig,
		data: '<figure class="image" style="width:20%;height:20%;"><img src="/images/parrot_2.jpg" alt=""></figure>'
	},
	{
		id: 'inline201',
		...
		config: commonConfig,
		data: '<p><picture>' +
					'<source srcset="/images/logo-square.png" media="(max-width: 800px)" type="image/png">' +
					'<source srcset="/images/logo-wide.png" media="(min-width: 800px)" type="image/png">' +
	...
	},
	{
		...
		data: '<p><picture>' +
					'<source srcset="/images/logo-square.png" media="(max-width: 800px)" type="image/png">' +
					'<source srcset="/images/logo-wide.png" media="(min-width: 800px)" type="image/png">' +
					'<img class="image_resized" style="width:50%;" src="/images/logo-wide.png" alt="">' +
				'</picture></p>'
	},
	{
		id: 'block201',
