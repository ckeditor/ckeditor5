...
import type { ModelDocumentSelection, Element, Selection, ViewElement, Match } from 'ckeditor5/src/engine.js';
...
export class ImageCaptionUtils extends Plugin {
	 ...
	 */
	public getCaptionFromModelSelection( selection: Selection | ModelDocumentSelection ): Element | null {
