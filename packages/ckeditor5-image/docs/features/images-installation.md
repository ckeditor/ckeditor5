...
<info-box info>
	...
	If your integrations depends on a ready–to–use editor build and you want to take advantage of updated CKEditor 5 but **without the support for inline images** (e.g. to maintain content compatibility), check out the {@link builds/guides/migration/migration-to-28 official migration guide} that will help you configure the editor.
</info-box>
