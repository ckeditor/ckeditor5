...
const editors = [
	{
		...
		config: commonConfig,
		data: '<p><img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt=""></p>'
	},
	{
		id: 'inline2',
		title: '[Inline] natural size | width + height attributes: Resize in %',
		config: commonConfig,
		data: '<p><img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline3',
		config: commonConfig,
		data: '<p><img style="width:22.69%;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" ' +
	...
	},
	{
		...
		data: '<p><img class="image_resized" style="width:22.69%;" ' +
			'src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt="" width="384" height="500"></p>',
		title: '[Inline] natural size | width + height attributes: Resized (width % style)'
	},
	{
		id: 'inline5',
	...
	},
	{
		...
		config: configPx,
		data: '<p><img style="height:400px;width:307px;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" ' +
			'alt="" width="384" height="500"></p>'
	},
	{
		id: 'inline8',
		...
		config: commonConfig,
		data: '<p><img style="width:384px;height:500px;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" ' +
			'alt=""></p>'
	},
	{
		id: 'inline9',
		...
		data: '<p><img class="image_resized" style="width:12.34%;" ' +
			'src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt=""></p>'
	},
	{
		id: 'inline10',
	...
	},
	{
		...
		config: commonConfig,
		data: '<p><img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt="" width="500" height="500"></p>'
	},
	{
		id: 'inline12',
		title: '[Inline] broken aspect ratio | styles only (w/o width & height attributes)',
		config: commonConfig,
		data: '<p><img style="width:500px;height:500px;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" ' +
			'alt=""></p>'
	},
	{
		id: 'block1',
		...
		config: commonConfig,
		data: '<figure class="image"><img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt=""></figure>'
	},
	{
		id: 'block2',
		title: '[Block] natural size | width + height attributes: Resize in %',
		config: commonConfig,
		data: '<figure class="image"><img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" width="384" ' +
	...
	},
	{
		...
		data: '<figure class="image" style="width:10.09%;">' +
			'<img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt="" width="384" height="500"></figure>'
	},
	{
		id: 'block4',
		title: '[Block] natural size | width + height attributes: Resized (width % style)',
	...
	},
	{
		...
		config: configPx,
		data: '<figure class="image"><img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" ' +
	...
	},
	{
		...
		data: '<figure class="image" style="width:384px;height:500px;">' +
			'<img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" alt=""></figure>'
	},
	{
		id: 'block9',
	...
	},
	{
		...
		data: '<figure class="image">' +
			'<img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/game_boy.jpg" width="500" height="500" alt=""></figure>'
	},
	{
		id: 'block12',
	...
	},
	{
		...
		config: commonConfig,
		data: '<p><img style="height:20%;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/birds/parrot_2.jpg" ' +
	...
	},
	{
		...
		config: configPx,
		data: '<p><img style="height:200px;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/birds/parrot_2.jpg" ' +
			'alt="" width="300" height="451"></p>'
	},
	{
		id: 'inline103',
		...
		config: commonConfig,
		data: '<p><img style="height:20%;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/birds/parrot_2.jpg" alt=""></p>'
	},
	{
		id: 'inline104',
	...
	},
	{
		...
		config: commonConfig,
		data: '<p><img style="width:20%;height:20%;" src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/birds/parrot_2.jpg" ' +
			'alt="" width="300" height="451"></p>'
	},
	{
		id: 'inline106',
	...
	},
	{
		...
		data: '<figure class="image" style="height:20%;">' +
			'<img src="https://ckeditor.com/docs/ckeditor5/latest/assets/img/birds/parrot_2.jpg" alt="" width="300" height="451"></figure>'
	},
	{
		id: 'block102',
