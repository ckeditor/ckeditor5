...
import CollapsibleView from '@ckeditor/ckeditor5-ui/src/collapsible/collapsibleview';
...
describe( 'ImageInsertFormView', () => {
	...
	describe( 'focus cycling', () => {
		let view, inputIntegrationView, buttonIntegrationView, otherButtonIntegrationView, collapsibleIntegrationView;

		beforeEach( () => {
			inputIntegrationView = new ImageInsertUrlView( { t: val => val } );
		...
		describe( 'single URL input integration', () => {
			beforeEach( () => {
				view = new ImageInsertFormView( { t: val => val }, [
					inputIntegrationView
				] );
			...
			it( 'forward cycling', () => {
				...
				view.focus();
				expect( view.focusTracker.focusedElement ).to.equal( inputIntegrationView.element );
				expect( inputIntegrationView.focusTracker.focusedElement ).to.equal( inputIntegrationView.urlInputView.element );

				view.keystrokes.press( keyEvtData );
				expect( view.focusTracker.focusedElement ).to.equal( inputIntegrationView.element );
				expect( inputIntegrationView.focusTracker.focusedElement ).to.equal( inputIntegrationView.urlInputView.element );

				inputIntegrationView.keystrokes.press( keyEvtData );
				expect( view.focusTracker.focusedElement ).to.equal( inputIntegrationView.element );
				expect( inputIntegrationView.focusTracker.focusedElement ).to.equal( inputIntegrationView.insertButtonView.element );

				inputIntegrationView.keystrokes.press( keyEvtData );
				expect( view.focusTracker.focusedElement ).to.equal( inputIntegrationView.element );
				expect( inputIntegrationView.focusTracker.focusedElement ).to.equal( inputIntegrationView.cancelButtonView.element );
		...
		describe( 'mixed integrations (button and URL input)', () => {
			beforeEach( () => {
				view = new ImageInsertFormView( { t: val => val }, [
					buttonIntegrationView,
					inputIntegrationView
			...
			it( 'forward cycling', () => {
				...
				view.focus();
				expect( view.focusTracker.focusedElement ).to.equal( buttonIntegrationView.element );
				expect( buttonIntegrationView.focusTracker ).to.be.undefined;
		...
		describe( 'mixed integrations (button and URL input inside a collapsible view)', () => {
			beforeEach( () => {
				collapsibleIntegrationView = new CollapsibleView( { t: val => val }, [ inputIntegrationView ] );
			...
			it( 'forward cycling', () => {
				...
				view.keystrokes.press( keyEvtData );
				expect( view.focusTracker.focusedElement ).to.equal( collapsibleIntegrationView.element );
				expect( collapsibleIntegrationView.focusTracker ).to.be.undefined;
