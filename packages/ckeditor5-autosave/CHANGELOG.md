...
* The first implementation of the autosave plugin. Check out the [demo](https://ckeditor.com/docs/ckeditor5/latest/getting-started/getting-and-setting-data.html#autosave-feature).
