...
/**
 * The {@glink getting-started/legacy/installation-methods/predefined-builds#classic-editor classic editor} implementation.
 ...
 * but it is also available in the {@glink getting-started/legacy/installation-methods/predefined-builds#classic-editor classic build}.
 *
...
export default class ClassicEditor extends DataApiMixin( ElementApiMixin( Editor ) ) {
	 ...
	 * (for example – `@ckeditor/ckeditor5-build-classic`).
	 *
