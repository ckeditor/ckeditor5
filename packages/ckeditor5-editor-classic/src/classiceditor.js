...
/**
 * The {@glink builds/guides/predefined/overview#classic-editor classic editor} implementation.
 ...
 * but it is also available in the {@glink builds/guides/predefined/overview#classic-editor classic build}.
 *
...
export default class ClassicEditor extends Editor {
	 ...
	 * {@glink builds/guides/predefined/overview editor build} (for example – `@ckeditor/ckeditor5-build-classic`).
	 *
