...
export default class ClassicEditorUIView extends BoxedEditorUIView {
	 ...
	 * @param {Array.<String>|Object} [options.toolbarItems]
	 */
	constructor( locale, editingView, componentsFactory, options = {} ) {
		super( locale );
		 ...
		 */
		this.toolbar = new ToolbarView( locale, componentsFactory, {
